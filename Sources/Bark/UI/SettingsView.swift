...
struct SettingsView: View {
    ...
    enum Pane: String, CaseIterable, Identifiable {
        case general, hotkey, modes, apps, models, history, permissions, privacy
...
// LLMStatusBadge moved to UI/LLMStatusBadge.swift (shared with the menu
// popover's model banner and onboarding).
...
private struct SpeakerEnrollmentSheet: View {
...
private struct GuardrailSection: View {
    let title: String
    let text: String
...
private struct PromptSections: View {
    let usesLLM: Bool
...
private struct BuiltInPromptEditor: View {
    @Bindable var controller: DictationController
    let shipped: Mode
    var dismiss: () -> Void
