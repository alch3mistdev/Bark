...
suggestion generation (ADR-010) — off by default, gated by an in-UI privacy warning that names
...
the keypress, confined to a single audited component (ADR-010). Refuse secure/password fields.
...
- **v2.0.0 (2026-07-16)**: Principle I — opt-in external LLM endpoint carve-out for suggestion
  ...
  responses. Both documented in ADR-010 with user sign-off (015-suggested-responses clarification
  session, 2026-07-16).
